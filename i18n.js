...
const resources = {
  en: {
    translation: {
      ...
      "menu-start-text": "Home Page",
      "menu-checkin-text": "Check In",
      "menu-inspection-text": "Inspection Zone",
      "menu-checkout-text": "Check Out",
      "menu-guardian-text": "Guardian Angel",
      "menu-about-text": "About Us",

      "about-title1": "Our History",

      "about-p1": "With a track record of over four decades, we have gained a deep understanding of the unique challenges and demands our customers face in various industrial sectors. This experience allows us to approach each project with insight and provide solutions that truly make a difference.",

      "about-p2": "At MATEC, we not only strive to solve the logistical and intralogistical challenges our customers face but also commit to helping them achieve their goals and exceed their expectations. We believe that strong collaboration and a personalized approach are the keys to success. That's why each project is an opportunity for us to deliver exceptional service and build lasting relationships with our clients.",

      "about-title2": "About Us",

      "about-p3": "At MATEC, intralogistics is more than a business; it's our passion and commitment. Since our foundation over four decades ago, we have endeavored to be the benchmark company in the world of intralogistics, making a difference through our dedication to engineering, deep industry knowledge, and unwavering closeness to our valued customers.",

      "about-title3": "Subscribe to Our Newsletter",

      "about-p4": "You can subscribe to our newsletter and receive the latest updates",
  ...
  de: {
    translation: {
      ...
      "functions-title1": "MATECs Inspektionszone der Stufe 3",
      ...
      "menu-start-text": "Startseite",
      "menu-checkin-text": "Einchecken",
      "menu-inspection-text": "Inspektionsbereich",
      "menu-checkout-text": "Auschecken",
      "menu-guardian-text": "Schutzengel",
      "menu-about-text": "Über uns",

      "about-title1": "Unsere Geschichte",

      "about-p1": "Mit einer über vier Jahrzehnte langen Erfolgsgeschichte haben wir ein tiefes Verständnis für die einzigartigen Herausforderungen und Anforderungen gewonnen, denen sich unsere Kunden in verschiedenen Industriezweigen gegenübersehen. Diese Erfahrung ermöglicht es uns, jeden Auftrag mit Einsicht anzugehen und Lösungen zu bieten, die wirklich einen Unterschied machen.",

      "about-p2": "Bei MATEC streben wir nicht nur danach, die logistischen und intralogistischen Herausforderungen unserer Kunden zu lösen, sondern verpflichten uns auch dazu, ihnen bei der Erreichung ihrer Ziele zu helfen und ihre Erwartungen zu übertreffen. Wir glauben, dass eine starke Zusammenarbeit und ein individueller Ansatz der Schlüssel zum Erfolg sind. Deshalb ist für uns jeder Auftrag eine Gelegenheit, außergewöhnlichen Service zu bieten und langanhaltende Beziehungen zu unseren Kunden aufzubauen.",

      "about-title2": "Über Uns",

      "about-p3": "Bei MATEC ist die Intralogistik mehr als nur ein Geschäft; sie ist unsere Leidenschaft und unser Engagement. Seit unserer Gründung vor über vier Jahrzehnten bemühen wir uns, das Referenzunternehmen in der Welt der Intralogistik zu sein und einen Unterschied durch unsere Hingabe zur Ingenieurkunst, tiefes Branchenwissen und unerschütterliche Nähe zu unseren geschätzten Kunden zu machen.",

      "about-title3": "Abonnieren Sie unseren Newsletter",

      "about-p4": "Sie können unseren Newsletter abonnieren und die neuesten Updates erhalten",
  ...
  cn: {
    translation: {
      ...
      "menu-start-text": "首页",
      "menu-checkin-text": "入住",
      "menu-inspection-text": "检查区",
      "menu-checkout-text": "退房",
      "menu-guardian-text": "守护天使",
      "menu-about-text": "关于我们",

      "about-title1": "我们的历史",

      "about-p1": "拥有四十多年的历史，我们深刻理解各种工业领域客户面临的独特挑战和需求。这种经验使我们能够深入了解每个项目，提供真正有影响力的解决方案。",

      "about-p2": "在MATEC，我们不仅努力解决客户在物流和内部物流方面的挑战，还承诺帮助他们实现目标并超越期望。我们认为强大的合作和个性化的方法是成功的关键。这就是为什么每个项目对我们来说都是提供卓越服务并与客户建立持久关系的机会。",

      "about-title2": "关于我们",

      "about-p3": "在MATEC，内部物流不仅仅是一门生意；它是我们的激情和承诺。自四十多年前创立以来，我们一直致力于成为内部物流领域的标杆公司，通过我们对工程学的热忱、深刻的行业知识和对珍贵客户的不懈亲近，产生影响。",

      "about-title3": "订阅我们的通讯",

      "about-p4": "您可以订阅我们的通讯，获取最新信息",
  ...
  fr: {
    translation: {
      ...
      "functions-title1": "Zone d'inspection de niveau 3 de MATEC",
      ...
      "menu-start-text": "Page d'accueil",
      "menu-checkin-text": "Enregistrement",
      "menu-inspection-text": "Zone d'inspection",
      "menu-checkout-text": "Départ",
      "menu-guardian-text": "Ange gardien",
      "menu-about-text": "À propos de nous",

      "about-title1": "Notre Histoire",

      "about-p1": "Avec plus de quatre décennies d'expérience, nous avons acquis une compréhension profonde des défis uniques et des demandes auxquels sont confrontés nos clients dans divers secteurs industriels. Cette expérience nous permet d'aborder chaque projet avec perspicacité et de fournir des solutions qui font vraiment la différence.",

      "about-p2": "Chez MATEC, nous nous efforçons non seulement de résoudre les défis logistiques et intralogistiques auxquels nos clients sont confrontés, mais nous nous engageons également à les aider à atteindre leurs objectifs et à dépasser leurs attentes. Nous croyons qu'une collaboration solide et une approche personnalisée sont la clé du succès. C'est pourquoi chaque projet est pour nous l'occasion de fournir un service exceptionnel et de construire des relations durables avec nos clients.",

      "about-title2": "À Propos de Nous",

      "about-p3": "Chez MATEC, l'intralogistique est plus qu'une affaire ; c'est notre passion et notre engagement. Depuis notre fondation il y a plus de quatre décennies, nous nous efforçons d'être l'entreprise de référence dans le monde de l'intralogistique, en faisant la différence grâce à notre dévouement à l'ingénierie, notre connaissance approfondie de l'industrie et notre proximité inébranlable avec nos précieux clients.",

      "about-title3": "Abonnez-vous à notre newsletter",

      "about-p4": "Vous pouvez vous abonner à notre newsletter et recevoir les dernières mises à jour",
  ...
  pt: {
    translation: {
      ...
      "functions-title1": "Zona de Inspeção de Nível 3 da MATEC",
      ...
      "menu-start-text": "Página inicial",
      "menu-checkin-text": "Check-in",
      "menu-inspection-text": "Zona de inspeção",
      "menu-checkout-text": "Check-out",
      "menu-guardian-text": "Anjo Guardião",
      "menu-about-text": "Sobre nós",

      "about-title1": "Nossa História",

      "about-p1": "Com mais de quatro décadas de experiência, adquirimos um profundo entendimento dos desafios e demandas únicas enfrentados pelos nossos clientes em diversos setores industriais. Essa experiência nos permite abordar cada projeto com perspicácia e fornecer soluções que realmente fazem a diferença.",

      "about-p2": "Na MATEC, não apenas buscamos resolver os desafios logísticos e intralogísticos enfrentados pelos nossos clientes, mas também nos comprometemos a ajudá-los a alcançar seus objetivos e superar suas expectativas. Acreditamos que uma colaboração sólida e uma abordagem personalizada são a chave para o sucesso. É por isso que cada projeto é uma oportunidade para nós fornecermos um serviço excepcional e construirmos relacionamentos duradouros com nossos clientes.",

      "about-title2": "Sobre Nós",

      "about-p3": "Na MATEC, a intralogística é mais do que um negócio; é a nossa paixão e compromisso. Desde a nossa fundação há mais de quatro décadas, temos nos esforçado para ser a empresa de referência no mundo da intralogística, fazendo a diferença por meio da nossa dedicação à engenharia, conhecimento profundo da indústria e proximidade inabalável com os nossos valiosos clientes.",

      "about-title3": "Assine a nossa Newsletter",

      "about-p4": "Você pode assinar a nossa newsletter e receber as últimas atualizações",

      "about-subscribe": "Assinar",
  ...
  es: {
    translation: {
      ...
      "functions-title1": "Zona de Inspección de Nivel 3 de MATEC",
